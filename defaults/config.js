...
module.exports = {
	...
	//
	// The Lounge ships with a few themes (`crypto`, `example`, `morning`, and
	// `zenburn`) and can be extended by installing more themes. Read more about how
	// to manage them [here](https://thelounge.github.io/docs/packages/themes).
	//
	...
	// and always loading images from The Lounge and making all assets secure,
	...
	// one.
	//
	// This value is set to `"The Lounge - https://thelounge.github.io"` by
	// default.
	...
	// `$THELOUNGE_HOME/users/<user>.json`. When enabled, logs will be stored in
	// the `$THELOUNGE_HOME/logs/<user>/<network>/` directory.
	//
